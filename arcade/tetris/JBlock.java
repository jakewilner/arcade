...
/**
 *This class contains all the logic for the J piece
 */

public class JBlock extends Piece {


    public JBlock(Rectangle[][] myBoard, ArrayList<Piece> myPieceList, Timeline timeline, Pane gamePane) {
    ...
    /**
     *This method sets up the coordinates for the J block
     */
    ...
    /**
     *This method returns the case for the J block
     */
    @Override
    public int getCase() {
        return 3;
