 ...
 */
    private ImageView generateInfo(int num) {
        switch (num) {
            case 0:
                return new ImageView(new Image("./arcade/tetris/I_piece.png"));
            case 1:
                return new ImageView(new Image("./arcade/tetris/Z_piece.png"));
            case 2:
                return new ImageView(new Image("./arcade/tetris/T_piece.png"));
            case 3:
                return new ImageView(new Image("./arcade/tetris/J_piece.png"));
            case 4:
                return new ImageView(new Image("./arcade/tetris/L_piece.png"));
            case 5:
                return new ImageView(new Image("./arcade/tetris/S_piece.png"));
            case 6:
                return new ImageView(new Image("./arcade/tetris/O_piece.png"));
            default:
                return new ImageView(new Image("./arcade/tetris/black.png"));
        }
    }
/**
 ...
 */
    public void updateIncrementingLabel() {
        if (PaneOrganizer.isIncrementingMode) {
            ...
            if (!this.gamePane.getChildren().contains(this.incrementingLevelRect) &&
                    !this.gamePane.getChildren().contains(this.incrementingLevel)){
 ...
 */
    private void checkKey(KeyEvent e) {
        if (!Piece.gameOver) {
            ...
            if (!this.pieceList.isEmpty()) {
                this.pieceList.get(0).checkKey(e, this.running);
            }
            e.consume();
        }
    }
