...
/**
 *This class contains all the logic for the O piece
 */
public class OBlock extends Piece {

    public OBlock(Rectangle[][] myBoard, ArrayList<Piece> myPieceList, Timeline timeline, Pane gamePane) {
    ...
    /**
     *This method sets up the coordinates for the O block
     */
    ...
    /**
     *This makes sure the O block doesn't rotate
     */
    @Override
    public void rotate(){
    ...
    /**
     *This method returns the case for the O block
     */
    @Override
    public int getCase() {
        return 6;
