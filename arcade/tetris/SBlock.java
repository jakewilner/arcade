...
/**
 *This class contains all the logic for the S piece
 */
public class SBlock extends Piece {


    public SBlock(Rectangle[][] myBoard, ArrayList<Piece> myPieceList, Timeline timeline, Pane gamePane) {
    ...
    /**
     *This method sets up the coordinates for the S block
     */
    ...
    /**
     *This method returns the case for the S block
     */
    @Override
    public int getCase() {
        return 5;
