...
public class PaneOrganizer {
    ...
    public PaneOrganizer(Stage stage) {
        //String path = getClass().getResource("/tetristheme.mp3").toString();
        ...
        this.startScreenImageView = new ImageView(
                new Image("./arcade/tetris/start screen.png"));
        this.clickImageView = new ImageView(
                new Image("./arcade/tetris/T_starter.png"));
    ...
    private void setUpGraphically() {
        this.buttonPane.getChildren().addAll(
                this.mute, this.restart, this.quit, this.back, this.easy, this.med, this.hard, this.incrementing, this.scoreLabel,
                this.highScore);
